...
abstract class HttpSource : CatalogueSource {
     ...
     *
     * This is typically the root address that serves as the main entry point to the
     * site's content. Used in the browse screen to determine the URL opened when
     * tapping "Open in WebView".
     *
